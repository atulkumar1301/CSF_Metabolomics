...
df <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/A_Beta/Medication/7_Full_Result_Data_Analysis_A_Beta_Medication.txt")
...
p <- p + scale_x_continuous(breaks = round(seq(-0.9, 0.3, by = 0.1),1))
...
df_2 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/TauPET/Medication/7_Full_Result_Data_Analysis_Taupet_Medication.txt")
...
df_4 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/A_Syn/Medication/7_Full_Result_Data_Analysis_A_Syn_Medication.txt")
...
df_6 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/WML/Medication/7_Full_Result_Data_Analysis_WML_Medication.txt")
...
p_6 <- p_6 + scale_x_continuous(breaks = round(seq(-0.9, 1, by = 0.2), 1))
...
df_1 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/Medication/7_Full_Result_Data_Analysis_Ab_Medication.txt")
...
p_1 <- p_1 + scale_x_continuous(breaks = round(seq(-0.9, 0.31, by = 0.1),1))
...
df_3 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/Medication/7_Full_Result_Data_Analysis_Taupet_Medication.txt")
...
p_3 <- p_3 + scale_x_continuous(breaks = round(seq(-0.3, 0.4, by = 0.1),1))
...
df_5 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/Medication/7_Full_Result_Data_Analysis_Asyn_Medication.txt")
...
p_5 <- p_5 + scale_x_continuous(breaks = round(seq(-0.3, 0.7, by = 0.2), 1))
...
df_7 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/Medication/7_Full_Result_Data_Analysis_WML_Medication.txt")
...
p_7 <- p_7 + scale_x_continuous(breaks = round(seq(-1, 0.8, by = 0.2), 1))
