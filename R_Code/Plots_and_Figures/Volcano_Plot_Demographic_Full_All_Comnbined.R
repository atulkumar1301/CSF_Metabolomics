...
df <- fread ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/Demographics/Full/7_Full_Result_Data_Analysis_Age_Full.txt")
...
df_2 <- fread ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/Demographics/Full/7_Full_Result_Data_Analysis_Gender_Full.txt")
...
p_4 <- p_4 +
  theme(legend.position="left",
        ...
        legend.title = element_text(family = "serif", size=16),
        legend.text = element_text(family = "serif", size=16),
        panel.background = element_blank()) + labs(title=expression("c) CU/CI Status"))
p_4
...
plot <- ggarrange(p, p_2, p_4, p_1, p_3, p_5, common.legend = TRUE, legend = "bottom")
