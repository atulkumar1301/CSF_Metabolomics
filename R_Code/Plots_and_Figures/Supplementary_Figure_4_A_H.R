...
df <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/A_Beta/7_Full_Result_Data_Analysis_Abeta_No_Dynamics.txt")
...
p <- p + scale_x_continuous(breaks = round(seq(-1.5, 0.3, by = 0.2),1))
...
df_2 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/TauPET/7_Full_Result_Data_Analysis_Taupet_No_Dynamics.txt")
...
p_2 <- p_2 + scale_x_continuous(breaks = round(seq(-0.6, 0.4, by = 0.1),1))
...
p_2 <- p_2 +
  theme(legend.position="left",
        ...
        legend.title = element_text(family = "serif", size=16),
        legend.text = element_text(family = "serif", size=16),
        panel.background = element_blank()) + labs(title=expression("C TauPET"))
p_2

####Asyn

df_4 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/A_Syn/7_Full_Result_Data_Analysis_Asyn_No_Dynamics.txt")
...
p_4 <- p_4 + scale_x_continuous(breaks = round(seq(-0.4, 0.8, by = 0.2), 1))
p_4 <- p_4 + scale_y_continuous(breaks = round (seq (0, 15, by = 3), 1))
...
p_4 <- p_4 +
  theme(legend.position="left",
        ...
        legend.title = element_text(family = "serif", size=16),
        legend.text = element_text(family = "serif", size=16),
        panel.background = element_blank()) + labs(title=expression("E "*alpha*"Syn-SAA"))
p_4

####WML

df_6 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/WML/7_Full_Result_Data_Analysis_WML_No_Dynamics.txt")
...
p_6 <- p_6 + scale_x_continuous(breaks = round(seq(-0.7, 0.7, by = 0.2), 1))
p_6 <- p_6 + scale_y_continuous(breaks = round (seq (0, 8, by = 2), 1))
...
p_6 <- p_6 +
  theme(legend.position="left",
        ...
        legend.title = element_text(family = "serif", size=16),
        legend.text = element_text(family = "serif", size=16),
        panel.background = element_blank()) + labs(title=expression("G WML"))
p_6

#plot <- ggarrange(p, p_2, p_4, p_6, common.legend = TRUE, legend = "bottom")
#annotate_figure(plot, top = text_grob(expression("Individual effects of all pathologies on CSF Metabolites"), color = "#999999", face = "bold", size = 20, family = "serif"))


####Abeta adjusted for other pathologies

df_1 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/7_Full_Result_Data_Analysis_Ab_No_Dynamics.txt")
...
p_1 <- p_1 + geom_hline (aes(yintercept=-log10(0.05), linetype = "p-value 0.05", col="black")) +
  geom_hline (aes (yintercept=-log10(0.000398936176), linetype = "FDR p-value 0.05", col="#D55E00")) +
  scale_linetype_manual(name = "p-value cut off", values = c(2, 2), 
                        guide = guide_legend(override.aes = list(color = c("black", "#D55E00")))) 
...
p_1 <- p_1 +
  theme(legend.position="left",
        ...
        legend.title = element_text(family = "serif", size=16),
        legend.text = element_text(family = "serif", size=16),
        panel.background = element_blank()) + labs(title=expression("B A"*beta*": Adjusted for other co-pathologies"))
p_1


###TauPET adjusted for other pathologies

df_3 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/7_Full_Result_Data_Analysis_Taupet_No_Dynamics.txt")
...
p_3 <- p_3 + scale_x_continuous(breaks = round(seq(-0.4, 0.4, by = 0.1),1))
...
p_3 <- p_3 +
  theme(legend.position="left",
        ...
        legend.title = element_text(family = "serif", size=16),
        legend.text = element_text(family = "serif", size=16),
        panel.background = element_blank()) + labs(title=expression("D TauPET: Adjusted for other co-pathologies"))
p_3


##Asyn adjusted for other pathologies

df_5 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/7_Full_Result_Data_Analysis_Asyn_No_Dynamics.txt")
...
p_5 <- p_5 + scale_x_continuous(breaks = round(seq(-0.7, 0.8, by = 0.2), 1))
p_5 <- p_5 + scale_y_continuous(breaks = round (seq (0, 17, by = 3), 1))
...
p_5 <- p_5 +
  theme(legend.position="left",
        ...
        legend.title = element_text(family = "serif", size=16),
        legend.text = element_text(family = "serif", size=16),
        panel.background = element_blank()) + labs(title=expression("F "*alpha*"Syn-SAA: Adjusted for other co-pathologies"))
p_5


###WML adjusted for other pathologies

df_7 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/7_Full_Result_Data_Analysis_WML_No_Dynamics.txt")
...
p_7 <- p_7 + scale_x_continuous(breaks = round(seq(-1, 0.9, by = 0.2), 1))
p_7 <- p_7 + scale_y_continuous(breaks = round (seq (0, 15, by = 2), 1))
