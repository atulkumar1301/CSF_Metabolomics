...
p <- p + scale_x_continuous(breaks = round(seq(-1.5, 0.3, by = 0.3),1))
...
p_6 <- p_6 + scale_x_continuous(breaks = round(seq(-0.7, 0.7, by = 0.3), 1))
...
p_3 <- p_3 + scale_x_continuous(breaks = round(seq(-0.4, 0.4, by = 0.2),1))
...
p_5 <- p_5 + scale_x_continuous(breaks = round(seq(-0.7, 0.8, by = 0.3), 1))
...
p_7 <- p_7 + scale_x_continuous(breaks = round(seq(-1, 0.9, by = 0.3), 1))
