...
df <- fread ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/MMSE/7_Full_Result_Data_Analysis_MMSE.txt")
...
p <- p + scale_x_continuous(breaks = round(seq(-0.05, 0.09, by = 0.001),1))
...
p <- p +
  theme(legend.position="left",
        ...
        panel.background = element_blank()) + labs(title=expression("MMSE"))
p
