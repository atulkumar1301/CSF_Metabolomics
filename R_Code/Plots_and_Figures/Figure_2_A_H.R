...
df <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/A_Beta/7_Full_Result_Data_Analysis_Abeta.txt")
...
p <- p + scale_x_continuous(breaks = round(seq(-1.5, 0.5, by = 0.1),1))
...
df_4 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/A_Syn/7_Full_Result_Data_Analysis_A_Syn.txt")
...
p_4 <- p_4 + scale_x_continuous(breaks = round(seq(-0.5, 0.8, by = 0.1), 1))
...
df_6 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/WML/7_Full_Result_Data_Analysis_WML.txt")
...
p_6 <- p_6 + scale_x_continuous(breaks = round(seq(-1.1, 0.9, by = 0.1), 1))
...
df_1 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/7_Full_Result_Data_Analysis_Ab.txt")
...
df_3 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/7_Full_Result_Data_Analysis_Taupet.txt")
...
p_3 <- p_3 + scale_x_continuous(breaks = round(seq(-0.6, 0.4, by = 0.1),1))
...
df_5 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/7_Full_Result_Data_Analysis_Asyn.txt")
...
p_5 <- p_5 + scale_x_continuous(breaks = round(seq(-0.5, 0.7, by = 0.1), 1))
...
df_7 <- fread ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/7_Full_Result_Data_Analysis_WML_.txt")
...
p_7 <- p_7 + scale_x_continuous(breaks = round(seq(-1, 1, by = 0.1), 1))
