...
df <- fread ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_1/Age_Stratified/Age_Stratified_Less_Than_40/4_Full_Result_Data_Analysis_Raw_Adjusted.txt")
...
p <- p + scale_x_continuous(breaks = round(seq(-21, 4, by = 2),1))
p <- p + scale_y_continuous(breaks = round (seq (0, 4, by = 0.5), 1))
