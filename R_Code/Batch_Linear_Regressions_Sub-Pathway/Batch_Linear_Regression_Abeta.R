...
TABLE<-as.data.frame(matrix(ncol=12, nrow=71))
...
write.table (TABLE, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/Sub-Pathway/Ab/6_Result_Data_Analysis_A_beta.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
