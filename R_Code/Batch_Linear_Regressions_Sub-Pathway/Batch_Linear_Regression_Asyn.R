...
write.table (TABLE, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/Sub-Pathway/A_Syn/6_Result_Data_Analysis_A_Syn.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
