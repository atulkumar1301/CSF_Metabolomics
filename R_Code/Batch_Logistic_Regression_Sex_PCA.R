...
write.table (TABLE, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_1/PCA/12_Result_Data_Analysis_Raw_Adjusted.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
