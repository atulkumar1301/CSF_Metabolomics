...
df <- fread (file = "/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_1/Sex_Stratified/Male/5_Male_Data_Analysis_1_Full_Imputed.txt")
df_2 <- df [,1:29]
j <- 1
...
write.table (TABLE, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_1/Sex_Stratified/Male/6_Result_Data_Analysis_Age_Male.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
