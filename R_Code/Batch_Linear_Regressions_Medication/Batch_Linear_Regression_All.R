...
for (i in colnames (df)) {
  ...
  model <- glm (N_P ~ Abnormal_CSF_Ab42_Ab40_Ratio + tnic_cho_com_I_IV + SAA_Status + DV + Age + Gender + Recruitment_Bias + mean_standardized_metabolomic_level + AD_PD_Medication, data = df, family=gaussian)
  ...
  TABLE_WMH[j,11] <- summary(model)$coefficients[5, "t value"]
  j <- j + 1
}
...
write.table (TABLE_Ab, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/Medication/6_Result_Data_Analysis_Ab.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
write.table (TABLE_Tau, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/Medication/6_Result_Data_Analysis_Taupet.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
write.table (TABLE_Asyn, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/Medication/6_Result_Data_Analysis_Asyn.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
write.table (TABLE_WMH, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/Metabolites/All_Combined/Medication/6_Result_Data_Analysis_WML.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
