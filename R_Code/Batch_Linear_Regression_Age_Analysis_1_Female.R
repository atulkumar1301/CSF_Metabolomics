...
write.table (TABLE, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_1/Sex_Stratified/Female/6_Result_Data_Analysis_Age_Female.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
