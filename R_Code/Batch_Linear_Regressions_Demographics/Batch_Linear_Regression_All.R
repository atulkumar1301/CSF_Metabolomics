...
library(scales)
TABLE_Age <- as.data.frame(matrix(ncol=11, nrow=376))
names(TABLE_Age) <- c("Biomarker", "Effect", "OR","SE", "P", "R2", "L95", "U95", "AIC", "BIC", "t Value")

TABLE_Gender <-as.data.frame(matrix(ncol=11, nrow=376))
names(TABLE_Gender) <- c("Biomarker", "Effect", "OR","SE", "P", "R2", "L95", "U95", "AIC", "BIC", "t Value")

TABLE_CU_CI <- as.data.frame(matrix(ncol=11, nrow=376))
...
write.table (TABLE_Age, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/Demographics/All_Combined/6_Result_Data_Analysis_Age.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
write.table (TABLE_Gender, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/Demographics/All_Combined/6_Result_Data_Analysis_Gender.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
write.table (TABLE_CU_CI, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/Demographics/All_Combined/6_Result_Data_Analysis_CU_CI.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
