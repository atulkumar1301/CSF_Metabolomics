...
write.table (TABLE, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/Demographics/Full/6_Result_Data_Analysis_CU_CI_Full.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
