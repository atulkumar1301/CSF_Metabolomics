...
write.table (TABLE, (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/CUI/6_Result_Data_Analysis_Gender.txt")), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
