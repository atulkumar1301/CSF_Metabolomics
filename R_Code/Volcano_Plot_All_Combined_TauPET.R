...
df <- fread ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/All_Combined/7_Full_Result_Data_Analysis_Taupet.txt")
...
p <- p + geom_hline (aes(yintercept=-log10(0.05), linetype = "p-value 0.05", col="black")) +
  geom_hline (aes (yintercept=-log10(0.00041), linetype = "FDR p-value 0.05", col="#D55E00")) +
