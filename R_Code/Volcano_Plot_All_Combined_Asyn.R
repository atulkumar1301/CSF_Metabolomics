...
df <- fread ("/Volumes/ATUL_6TB/Work/Projects/CSF_Metabolomics/Analyses_2/All_Combined/7_Full_Result_Data_Analysis_Asyn.txt")
...
p <- p + scale_x_continuous(breaks = round(seq(-1, 32, by = 2), 1))
p <- p + scale_y_continuous(breaks = round (seq (0, 14, by = 1), 1))
